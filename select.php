    ...
    <table>
        ...
        ?>
            <tr>
                ...
                <td>
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a class="btn btn-outline-light" href="update.php?id_aset=<?php echo $data['id_aset']; ?>">Update</a>
                    <a class="btn btn-outline-light" href="delete.php?id_aset=<?php echo $data['id_aset']; ?>">Delete</a>
                </div>
                </td>
            </tr>
        <?php } ?>
